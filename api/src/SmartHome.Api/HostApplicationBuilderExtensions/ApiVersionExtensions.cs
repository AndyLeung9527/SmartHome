...
{
    public static IHostApplicationBuilder AddWebApiVersioning(this IHostApplicationBuilder builder)
    {
        ...
        foreach (var version in versions)
        {
            builder.Services.AddOpenApi(version, options =>
            {
                options.AddDocumentTransformer((document, context, cancellationToken) =>
                {
                    ...
                    document.Info.Title = $"Smart home API {apiDescription.ApiVersion}";
                    document.Info.Description = BuildDescription(apiDescription, $"Smart home API for version {apiDescription.ApiVersion}");
                    return Task.CompletedTask;
                });
            });
        }
